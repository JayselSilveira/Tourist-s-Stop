...
<body background="./Images/Travel.jpg">
    <div class="card" style="height: 95%">
        <div>
            <h4><a href="http://localhost/Project/adventures.php" style="color:#fabe28; margin-left:210px;">Places to Dine</a></h4><hr style="margin-bottom:10px;">
            <h2>Edit Page</h2>
        </div>
        ...
        <?php   // LOOP TILL END OF DATA 
          ...
          ?>
        <div class="form"></div>
        <form action="editFood.php?id=<?php echo $rows['post_id']?>" method="post" class="edit" enctype="multipart/form-data">
            <div class="field">
                <p>Name: 
