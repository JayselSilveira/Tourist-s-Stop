...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO posts(owner_name, owner_email, category, place_name, location, description, image) VALUES('$owner_name', '$owner_email', 'Food', '$place_name', '$location', '$description', '$image');";
